...
public final class ActivityMainBinding implements ViewBinding {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearLayout containerFragment = ViewBindings.findChildViewById(rootView, id);
      if (containerFragment == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, container, containerFragment);
    }
